...
export const items: Array<Project> = [
	{
		...
		color: 'white',
		description:
			`When I decided to create a golf course mobile app, I quickly found out that golf course APIs can be incredibly 
		...
		skills: getSkills('py', 'MySQL', 'js', 'fastapi', 'selenium', 'koyeb'),
		type: 'API'
	},
	{
		slug: 'fairwayfinder',
		color: 'white',
		description:
			`Currently a work in progress. I'm developing a golf GPS and stat keeping mobile app in JS and React Native that will utilize my own 
			...
			`,
		shortDescription:
			'A golf mobile app for score keeping, data tracking, GPS locating, and competition',
		links: [],
		logo: Assets.FairwayFinder,
		name: 'Fairway Finder',
		period: {
			from: new Date()
		},
		skills: getSkills('js', 'react', 'expo'),
		type: 'Mobile App',
		screenshots: [
		],
	},
	{
		...
		color: 'white',
		description:
			`In January of 2024, I stumbled on an Instagram page where somebody started with $1 and was sports betting his way 
		...
		skills: getSkills('py', 'MySQL', 'js', 'ensta', 'Heroku'),
		type: 'Website',
		screenshots:[
		]
	},
